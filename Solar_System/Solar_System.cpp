...
void myDisplay(void)
{
	...
	glPushMatrix();
	glRotatef(-fEarthRot, 0, 1, 0);
	glRotatef(4 * fEarthRot, 0, 1, 0);
	glutSolidSphere(13.0f, 30, 17);
	if (ShowAxis) DrawAxis(30.0f);
	...
	glRotatef(fMarsRot, 0, 1, 0);
	glTranslatef(180, 0.0f, 0.0f);
	glRotatef(2 * fMarsRot- fMarsRot, 0, 1, 0);
